...
#define AI_NETWORK_3_MODEL_SIGNATURE     "0x41eb99a29949d57a5683293f2eafc83f"
...
#define AI_TOOLS_DATE_TIME   "2026-04-22T20:37:10+0700"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    119056, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_3_IN_NUM, &input_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_3_OUT_NUM, &gemm_26_output),
  &input_Transpose_layer, 0x6ab7889e, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_3_activations_map, 1, params)) {
    ...
    input_output_array.data = AI_PTR(g_network_3_activations_map[0] + 15124);
    input_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 15124);
    input_Transpose_output_array.data = AI_PTR(g_network_3_activations_map[0] + 67072);
    input_Transpose_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 67072);
    conv2d_3_scratch0_array.data = AI_PTR(g_network_3_activations_map[0] + 119020);
    conv2d_3_scratch0_array.data_start = AI_PTR(g_network_3_activations_map[0] + 119020);
    conv2d_3_output_array.data = AI_PTR(g_network_3_activations_map[0] + 2720);
    conv2d_3_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 2720);
    nl_3_nl_output_array.data = AI_PTR(g_network_3_activations_map[0] + 2720);
    nl_3_nl_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 2720);
    conv2d_5_output_array.data = AI_PTR(g_network_3_activations_map[0] + 0);
    conv2d_5_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 0);
    conv2d_6_scratch0_array.data = AI_PTR(g_network_3_activations_map[0] + 26880);
    conv2d_6_scratch0_array.data_start = AI_PTR(g_network_3_activations_map[0] + 26880);
    conv2d_6_output_array.data = AI_PTR(g_network_3_activations_map[0] + 26912);
    conv2d_6_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 26912);
    nl_6_nl_output_array.data = AI_PTR(g_network_3_activations_map[0] + 26912);
    nl_6_nl_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 26912);
    conv2d_8_output_array.data = AI_PTR(g_network_3_activations_map[0] + 0);
    conv2d_8_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 0);
    conv2d_9_scratch0_array.data = AI_PTR(g_network_3_activations_map[0] + 13440);
    conv2d_9_scratch0_array.data_start = AI_PTR(g_network_3_activations_map[0] + 13440);
    conv2d_9_output_array.data = AI_PTR(g_network_3_activations_map[0] + 13504);
    conv2d_9_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 13504);
    nl_9_nl_output_array.data = AI_PTR(g_network_3_activations_map[0] + 40384);
    nl_9_nl_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 40384);
    conv2d_10_output_array.data = AI_PTR(g_network_3_activations_map[0] + 0);
    conv2d_10_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 0);
    conv2d_11_scratch0_array.data = AI_PTR(g_network_3_activations_map[0] + 26880);
    conv2d_11_scratch0_array.data_start = AI_PTR(g_network_3_activations_map[0] + 26880);
    conv2d_11_output_array.data = AI_PTR(g_network_3_activations_map[0] + 27008);
    conv2d_11_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 27008);
    nl_11_nl_output_array.data = AI_PTR(g_network_3_activations_map[0] + 67328);
    nl_11_nl_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 67328);
    conv2d_12_output_array.data = AI_PTR(g_network_3_activations_map[0] + 0);
    conv2d_12_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 0);
    conv2d_13_scratch0_array.data = AI_PTR(g_network_3_activations_map[0] + 40320);
    conv2d_13_scratch0_array.data_start = AI_PTR(g_network_3_activations_map[0] + 40320);
    conv2d_13_output_array.data = AI_PTR(g_network_3_activations_map[0] + 65296);
    conv2d_13_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 65296);
    transpose_14_output_array.data = AI_PTR(g_network_3_activations_map[0] + 0);
    transpose_14_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 0);
    nl_15_output_array.data = AI_PTR(g_network_3_activations_map[0] + 53760);
    nl_15_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 53760);
    reduce_16_output_array.data = AI_PTR(g_network_3_activations_map[0] + 0);
    reduce_16_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 0);
    reduce_16_Mul_output_array.data = AI_PTR(g_network_3_activations_map[0] + 256);
    reduce_16_Mul_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 256);
    gemm_18_output_array.data = AI_PTR(g_network_3_activations_map[0] + 0);
    gemm_18_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 0);
    nl_19_output_array.data = AI_PTR(g_network_3_activations_map[0] + 32);
    nl_19_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 32);
    gemm_20_output_array.data = AI_PTR(g_network_3_activations_map[0] + 64);
    gemm_20_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 64);
    nl_21_output_array.data = AI_PTR(g_network_3_activations_map[0] + 320);
    nl_21_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 320);
    eltwise_23_output_array.data = AI_PTR(g_network_3_activations_map[0] + 53760);
    eltwise_23_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 53760);
    reduce_24_output_array.data = AI_PTR(g_network_3_activations_map[0] + 0);
    reduce_24_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 0);
    reduce_24_Mul_output_array.data = AI_PTR(g_network_3_activations_map[0] + 256);
    reduce_24_Mul_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 256);
    gemm_26_output_array.data = AI_PTR(g_network_3_activations_map[0] + 0);
    gemm_26_output_array.data_start = AI_PTR(g_network_3_activations_map[0] + 0);
    return true;
  }
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_3_weights_map, 1, params)) {
    ...
    conv2d_3_weights_array.data = AI_PTR(g_network_3_weights_map[0] + 0);
    conv2d_3_weights_array.data_start = AI_PTR(g_network_3_weights_map[0] + 0);
    conv2d_3_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_3_bias_array.data = AI_PTR(g_network_3_weights_map[0] + 288);
    conv2d_3_bias_array.data_start = AI_PTR(g_network_3_weights_map[0] + 288);
    conv2d_5_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_5_weights_array.data = AI_PTR(g_network_3_weights_map[0] + 320);
    conv2d_5_weights_array.data_start = AI_PTR(g_network_3_weights_map[0] + 320);
    conv2d_5_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_5_bias_array.data = AI_PTR(g_network_3_weights_map[0] + 608);
    conv2d_5_bias_array.data_start = AI_PTR(g_network_3_weights_map[0] + 608);
    conv2d_6_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_6_weights_array.data = AI_PTR(g_network_3_weights_map[0] + 640);
    conv2d_6_weights_array.data_start = AI_PTR(g_network_3_weights_map[0] + 640);
    conv2d_6_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_6_bias_array.data = AI_PTR(g_network_3_weights_map[0] + 1152);
    conv2d_6_bias_array.data_start = AI_PTR(g_network_3_weights_map[0] + 1152);
    conv2d_8_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_8_weights_array.data = AI_PTR(g_network_3_weights_map[0] + 1216);
    conv2d_8_weights_array.data_start = AI_PTR(g_network_3_weights_map[0] + 1216);
    conv2d_8_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_8_bias_array.data = AI_PTR(g_network_3_weights_map[0] + 1792);
    conv2d_8_bias_array.data_start = AI_PTR(g_network_3_weights_map[0] + 1792);
    conv2d_9_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_9_weights_array.data = AI_PTR(g_network_3_weights_map[0] + 1856);
    conv2d_9_weights_array.data_start = AI_PTR(g_network_3_weights_map[0] + 1856);
    conv2d_9_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_9_bias_array.data = AI_PTR(g_network_3_weights_map[0] + 3904);
    conv2d_9_bias_array.data_start = AI_PTR(g_network_3_weights_map[0] + 3904);
    conv2d_10_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_10_weights_array.data = AI_PTR(g_network_3_weights_map[0] + 4032);
    conv2d_10_weights_array.data_start = AI_PTR(g_network_3_weights_map[0] + 4032);
    conv2d_10_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_10_bias_array.data = AI_PTR(g_network_3_weights_map[0] + 5184);
    conv2d_10_bias_array.data_start = AI_PTR(g_network_3_weights_map[0] + 5184);
    conv2d_11_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_11_weights_array.data = AI_PTR(g_network_3_weights_map[0] + 5312);
    conv2d_11_weights_array.data_start = AI_PTR(g_network_3_weights_map[0] + 5312);
    conv2d_11_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_11_bias_array.data = AI_PTR(g_network_3_weights_map[0] + 11456);
    conv2d_11_bias_array.data_start = AI_PTR(g_network_3_weights_map[0] + 11456);
    conv2d_12_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_12_weights_array.data = AI_PTR(g_network_3_weights_map[0] + 11648);
    conv2d_12_weights_array.data_start = AI_PTR(g_network_3_weights_map[0] + 11648);
    conv2d_12_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_12_bias_array.data = AI_PTR(g_network_3_weights_map[0] + 13376);
    conv2d_12_bias_array.data_start = AI_PTR(g_network_3_weights_map[0] + 13376);
    conv2d_13_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_13_weights_array.data = AI_PTR(g_network_3_weights_map[0] + 13568);
    conv2d_13_weights_array.data_start = AI_PTR(g_network_3_weights_map[0] + 13568);
    conv2d_13_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_13_bias_array.data = AI_PTR(g_network_3_weights_map[0] + 25856);
    conv2d_13_bias_array.data_start = AI_PTR(g_network_3_weights_map[0] + 25856);
    reduce_16_Mul_scale_array.format |= AI_FMT_FLAG_CONST;
    reduce_16_Mul_scale_array.data = AI_PTR(g_network_3_weights_map[0] + 26112);
    reduce_16_Mul_scale_array.data_start = AI_PTR(g_network_3_weights_map[0] + 26112);
    reduce_16_Mul_bias_array.format |= AI_FMT_FLAG_CONST;
    reduce_16_Mul_bias_array.data = AI_PTR(g_network_3_weights_map[0] + 26116);
    reduce_16_Mul_bias_array.data_start = AI_PTR(g_network_3_weights_map[0] + 26116);
    gemm_18_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_18_weights_array.data = AI_PTR(g_network_3_weights_map[0] + 26120);
    gemm_18_weights_array.data_start = AI_PTR(g_network_3_weights_map[0] + 26120);
    gemm_18_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_18_bias_array.data = AI_PTR(g_network_3_weights_map[0] + 28168);
    gemm_18_bias_array.data_start = AI_PTR(g_network_3_weights_map[0] + 28168);
    gemm_20_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_20_weights_array.data = AI_PTR(g_network_3_weights_map[0] + 28200);
    gemm_20_weights_array.data_start = AI_PTR(g_network_3_weights_map[0] + 28200);
    gemm_20_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_20_bias_array.data = AI_PTR(g_network_3_weights_map[0] + 30248);
    gemm_20_bias_array.data_start = AI_PTR(g_network_3_weights_map[0] + 30248);
    gemm_26_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_26_weights_array.data = AI_PTR(g_network_3_weights_map[0] + 30504);
    gemm_26_weights_array.data_start = AI_PTR(g_network_3_weights_map[0] + 30504);
    gemm_26_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_26_bias_array.data = AI_PTR(g_network_3_weights_map[0] + 31016);
    gemm_26_bias_array.data_start = AI_PTR(g_network_3_weights_map[0] + 31016);
    return true;
  }
